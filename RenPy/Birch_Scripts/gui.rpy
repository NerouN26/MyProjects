...
define gui.text_font = "DejaVuSans.ttf" # DejaVuSans.ttf

## Шрифт, используемый именами персонажей.
define gui.name_text_font = "DejaVuSans.ttf"

## Шрифт, используемый текстом вне игры.
define gui.interface_text_font = "ofont.ru_Unutterable.ttf"
...
## экрана.
define gui.navigation_xpos = 900 #900

## Вертикальная позиция индикатора пропуска.
define gui.skip_ypos = 15 #15

## Вертикальная позиция экрана уведомлений.
define gui.notify_ypos = 98 #98

## Интервал между выборами в меню.
define gui.choice_spacing = 33 #33
