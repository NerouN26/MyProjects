...
define config.window_title = u"Birch"
## Определяет, показывать ли заголовок, данный выше, на экране главного меню.
## Установите на False, чтобы спрятать заголовок.

define config.main_menu_music = "The Spirit.mp3"
...
define config.save_directory = "den-1668109748"
...
init python hide:
    ...
    if (today.month == 3) and (today.day == 19):
        ...
        config.mouse = { 'default' : [
            ("C:/Users/user/Desktop/Проекты Python/den/game/gui/mouse0.png", 0, 0),
            ("C:/Users/user/Desktop/Проекты Python/den/game/gui/mouse1.png", 0, 0),
            ("C:/Users/user/Desktop/Проекты Python/den/game/gui/mouse2.png", 0, 0),
            ("C:/Users/user/Desktop/Проекты Python/den/game/gui/mouse1.png", 0, 0),
        ] * 2 + [
            ("C:/Users/user/Desktop/Проекты Python/den/game/gui/mouse0.png", 0, 0),
        ] * (10 * 20)
